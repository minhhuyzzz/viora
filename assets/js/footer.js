    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                ...
                <p class="small opacity-50 mb-4">Thương hiệu thời trang cao cấp định nghĩa lại sự tối giản và sang trọng trong từng chi tiết sản phẩm.</p>
            ...
            <div class="col-lg-3 col-md-12 mb-4 mb-md-0">
                <h6 class="fw-bold small mb-4">BẢN ĐỒ</h6>
                <div class="viora-footer-map">
                    <iframe 
                        src="https://maps.google.com/maps?q=Trường+Đại+học+Công+nghiệp+TP.HCM&t=&z=16&ie=UTF8&iwloc=&output=embed" 
                        width="100%" 
                        height="150" 
